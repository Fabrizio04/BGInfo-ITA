...
if '%autouser%'=='1' echo Set WshShell = CreateObject("WScript.Shell") > "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo WshShell.Run chr(34) ^& "C:\BGInfo\cmd\it.bat" ^& Chr(34), 0 >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo Set WshShell = Nothing >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo IT_IT > "C:\BGInfo\cmd\%username%.txt" && set lang4=IT_IT
if '%autouser%'=='IT_IT' echo Set WshShell = CreateObject("WScript.Shell") > "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo WshShell.Run chr(34) ^& "C:\BGInfo\cmd\it.bat" ^& Chr(34), 0 >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo Set WshShell = Nothing >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo IT_IT > "C:\BGInfo\cmd\%username%.txt" && set lang4=IT_IT
if '%autouser%'=='it_it' echo Set WshShell = CreateObject("WScript.Shell") > "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo WshShell.Run chr(34) ^& "C:\BGInfo\cmd\it.bat" ^& Chr(34), 0 >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo Set WshShell = Nothing >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo IT_IT > "C:\BGInfo\cmd\%username%.txt" && set lang4=IT_IT
if '%autouser%'=='EN_US' echo Set WshShell = CreateObject("WScript.Shell") > "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo WshShell.Run chr(34) ^& "C:\BGInfo\cmd\en.bat" ^& Chr(34), 0 >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo Set WshShell = Nothing >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo EN_US > "C:\BGInfo\cmd\%username%.txt" && set lang4=EN_US
if '%autouser%'=='2' echo Set WshShell = CreateObject("WScript.Shell") > "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo WshShell.Run chr(34) ^& "C:\BGInfo\cmd\en.bat" ^& Chr(34), 0 >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo Set WshShell = Nothing >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo EN_US > "C:\BGInfo\cmd\%username%.txt" && set lang4=EN_US
if '%autouser%'=='en_us' echo Set WshShell = CreateObject("WScript.Shell") > "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo WshShell.Run chr(34) ^& "C:\BGInfo\cmd\en.bat" ^& Chr(34), 0 >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo Set WshShell = Nothing >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && echo EN_US > "C:\BGInfo\cmd\%username%.txt" && set lang4=EN_US
if '%autouser%'=='3' if exist "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" del "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo64.vbs" && if exist "C:\BGInfo\cmd\%username%.txt" del "C:\BGInfo\cmd\%username%.txt"
...
if '%autoall%'=='1' echo Set WshShell = CreateObject("WScript.Shell") > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo WshShell.Run chr(34) ^& "C:\BGInfo\cmd\it.bat" ^& Chr(34), 0 >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo Set WshShell = Nothing >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo IT_IT > "C:\BGInfo\cmd\All.txt" && set lang=IT_IT
if '%autoall%'=='IT_IT' echo Set WshShell = CreateObject("WScript.Shell") > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo WshShell.Run chr(34) ^& "C:\BGInfo\cmd\it.bat" ^& Chr(34), 0 >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo Set WshShell = Nothing >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo IT_IT > "C:\BGInfo\cmd\All.txt" && set lang=IT_IT
if '%autoall%'=='it_it' echo Set WshShell = CreateObject("WScript.Shell") > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo WshShell.Run chr(34) ^& "C:\BGInfo\cmd\it.bat" ^& Chr(34), 0 >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo Set WshShell = Nothing >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo IT_IT > "C:\BGInfo\cmd\All.txt" && set lang=IT_IT
if '%autoall%'=='EN_US' echo Set WshShell = CreateObject("WScript.Shell") > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo WshShell.Run chr(34) ^& "C:\BGInfo\cmd\en.bat" ^& Chr(34), 0 >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo Set WshShell = Nothing >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo EN_US > "C:\BGInfo\cmd\All.txt" && set lang=EN_US
if '%autoall%'=='2' echo Set WshShell = CreateObject("WScript.Shell") > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo WshShell.Run chr(34) ^& "C:\BGInfo\cmd\en.bat" ^& Chr(34), 0 >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo Set WshShell = Nothing >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo EN_US > "C:\BGInfo\cmd\All.txt" && set lang=EN_US
if '%autoall%'=='en_us' echo Set WshShell = CreateObject("WScript.Shell") > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo WshShell.Run chr(34) ^& "C:\BGInfo\cmd\en.bat" ^& Chr(34), 0 >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo Set WshShell = Nothing >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && echo EN_US > "C:\BGInfo\cmd\All.txt" && set lang=EN_US
if '%autoall%'=='3' if exist "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" del "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo64.vbs" && if exist "C:\BGInfo\cmd\All.txt" del "C:\BGInfo\cmd\All.txt"
