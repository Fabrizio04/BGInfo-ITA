...
if '%lingua%'=='1' "%~dp0\Bginfo.exe" "%~dp0\bgi\it.bgi" /timer:0 /nolicprompt
if '%lingua%'=='IT_IT' "%~dp0\Bginfo.exe" "%~dp0\bgi\it.bgi" /timer:0 /nolicprompt
if '%lingua%'=='it_it' "%~dp0\Bginfo.exe" "%~dp0\bgi\it.bgi" /timer:0 /nolicprompt
if '%lingua%'=='2' "%~dp0\Bginfo.exe" "%~dp0\bgi\en.bgi" /timer:0 /nolicprompt
if '%lingua%'=='EN_US' "%~dp0\Bginfo.exe" "%~dp0\bgi\en.bgi" /timer:0 /nolicprompt
if '%lingua%'=='en_us' "%~dp0\Bginfo.exe" "%~dp0\bgi\en.bgi" /timer:0 /nolicprompt
...
if '%modifica%'=='1' "%~dp0\Bginfo.exe" "%~dp0\bgi\it.bgi" /timer:500 /nolicprompt
if '%modifica%'=='IT_IT' "%~dp0\Bginfo.exe" "%~dp0\bgi\it.bgi" /timer:500 /nolicprompt
if '%modifica%'=='it_it' "%~dp0\Bginfo.exe" "%~dp0\bgi\it.bgi" /timer:500 /nolicprompt
if '%modifica%'=='2' "%~dp0\Bginfo.exe" "%~dp0\bgi\en.bgi" /timer:500 /nolicprompt
if '%modifica%'=='EN_US' "%~dp0\Bginfo.exe" "%~dp0\bgi\en.bgi" /timer:500 /nolicprompt
if '%modifica%'=='en_us' "%~dp0\Bginfo.exe" "%~dp0\bgi\en.bgi" /timer:500 /nolicprompt
...
if '%autouser%'=='1' echo Set WshShell = CreateObject("WScript.Shell") > "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo WshShell.Run chr(34) ^& "C:\Program Files\BGInfo\cmd\it.bat" ^& Chr(34), 0 >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo Set WshShell = Nothing >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo IT_IT > "C:\Program Files\BGInfo\cmd\%username%.txt" && set lang4=IT_IT
if '%autouser%'=='IT_IT' echo Set WshShell = CreateObject("WScript.Shell") > "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo WshShell.Run chr(34) ^& "C:\Program Files\BGInfo\cmd\it.bat" ^& Chr(34), 0 >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo Set WshShell = Nothing >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo IT_IT > "C:\Program Files\BGInfo\cmd\%username%.txt" && set lang4=IT_IT
if '%autouser%'=='it_it' echo Set WshShell = CreateObject("WScript.Shell") > "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo WshShell.Run chr(34) ^& "C:\Program Files\BGInfo\cmd\it.bat" ^& Chr(34), 0 >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo Set WshShell = Nothing >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo IT_IT > "C:\Program Files\BGInfo\cmd\%username%.txt" && set lang4=IT_IT
if '%autouser%'=='EN_US' echo Set WshShell = CreateObject("WScript.Shell") > "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo WshShell.Run chr(34) ^& "C:\Program Files\BGInfo\cmd\en.bat" ^& Chr(34), 0 >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo Set WshShell = Nothing >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo EN_US > "C:\Program Files\BGInfo\cmd\%username%.txt" && set lang4=EN_US
if '%autouser%'=='2' echo Set WshShell = CreateObject("WScript.Shell") > "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo WshShell.Run chr(34) ^& "C:\Program Files\BGInfo\cmd\en.bat" ^& Chr(34), 0 >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo Set WshShell = Nothing >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo EN_US > "C:\Program Files\BGInfo\cmd\%username%.txt" && set lang4=EN_US
if '%autouser%'=='en_us' echo Set WshShell = CreateObject("WScript.Shell") > "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo WshShell.Run chr(34) ^& "C:\Program Files\BGInfo\cmd\en.bat" ^& Chr(34), 0 >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo Set WshShell = Nothing >> "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && echo EN_US > "C:\Program Files\BGInfo\cmd\%username%.txt" && set lang4=EN_US
if '%autouser%'=='3' if exist "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" del "%userprofile%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Bginfo.vbs" && if exist "C:\Program Files\BGInfo\cmd\%username%.txt" del "C:\Program Files\BGInfo\cmd\%username%.txt"
...
if '%autoall%'=='1' echo Set WshShell = CreateObject("WScript.Shell") > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo WshShell.Run chr(34) ^& "C:\Program Files\BGInfo\cmd\it.bat" ^& Chr(34), 0 >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo Set WshShell = Nothing >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo IT_IT > "C:\Program Files\BGInfo\cmd\All.txt" && set lang=IT_IT
if '%autoall%'=='IT_IT' echo Set WshShell = CreateObject("WScript.Shell") > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo WshShell.Run chr(34) ^& "C:\Program Files\BGInfo\cmd\it.bat" ^& Chr(34), 0 >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo Set WshShell = Nothing >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo IT_IT > "C:\Program Files\BGInfo\cmd\All.txt" && set lang=IT_IT
if '%autoall%'=='it_it' echo Set WshShell = CreateObject("WScript.Shell") > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo WshShell.Run chr(34) ^& "C:\Program Files\BGInfo\cmd\it.bat" ^& Chr(34), 0 >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo Set WshShell = Nothing >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo IT_IT > "C:\Program Files\BGInfo\cmd\All.txt" && set lang=IT_IT
if '%autoall%'=='EN_US' echo Set WshShell = CreateObject("WScript.Shell") > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo WshShell.Run chr(34) ^& "C:\Program Files\BGInfo\cmd\en.bat" ^& Chr(34), 0 >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo Set WshShell = Nothing >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo EN_US > "C:\Program Files\BGInfo\cmd\All.txt" && set lang=EN_US
if '%autoall%'=='2' echo Set WshShell = CreateObject("WScript.Shell") > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo WshShell.Run chr(34) ^& "C:\Program Files\BGInfo\cmd\en.bat" ^& Chr(34), 0 >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo Set WshShell = Nothing >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo EN_US > "C:\Program Files\BGInfo\cmd\All.txt" && set lang=EN_US
if '%autoall%'=='en_us' echo Set WshShell = CreateObject("WScript.Shell") > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo WshShell.Run chr(34) ^& "C:\Program Files\BGInfo\cmd\en.bat" ^& Chr(34), 0 >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo Set WshShell = Nothing >> "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && echo EN_US > "C:\Program Files\BGInfo\cmd\All.txt" && set lang=EN_US
if '%autoall%'=='3' if exist "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" del "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Bginfo.vbs" && if exist "C:\Program Files\BGInfo\cmd\All.txt" del "C:\Program Files\BGInfo\cmd\All.txt"
